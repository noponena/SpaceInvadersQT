...
inline GameObjects::ConcreteType concreteTypeFromString(const std::string& typeStr) {
    static const std::unordered_map<std::string, GameObjects::ConcreteType> lookup = {
                                                                         ...
                                                                         {"WAVE_OF_DESTRUCTION", GameObjects::ConcreteType::WAVE_OF_DESTRUCTION},
...
inline std::string concreteTypeToString(const GameObjects::ConcreteType type) {
    switch (type) {
    case GameObjects::ConcreteType::PLAYER_SHIP:           return "PLAYER_SHIP";
    case GameObjects::ConcreteType::ENEMY_SHIP:            return "ENEMY_SHIP";
    case GameObjects::ConcreteType::PROJECTILE:            return "PROJECTILE";
    case GameObjects::ConcreteType::VORTEX:                return "VORTEX";
    case GameObjects::ConcreteType::WAVE_OF_DESTRUCTION:   return "WAVE_OF_DESTRUCTION";
    case GameObjects::ConcreteType::STELLAR_COIN:          return "STELLAR_COIN";
    case GameObjects::ConcreteType::HEALTH:                return "HEALTH";
