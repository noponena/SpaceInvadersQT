...
enum {
  ...
  SF_CHANNEL_MAP_REAR_CENTER, /* Apple calls this 'Center Surround', Msft calls
                                 this 'Back Center' */
  SF_CHANNEL_MAP_REAR_LEFT, /* Apple calls this 'Left Surround', Msft calls this
                               'Back Left' */
  SF_CHANNEL_MAP_REAR_RIGHT, /* Apple calls this 'Right Surround', Msft calls
                                this 'Back Right' */
  SF_CHANNEL_MAP_LFE, /* Apple calls this 'LFEScreen', Msft calls this 'Low
                         Frequency'  */
...
enum { /*
       **	The loop mode field in SF_INSTRUMENT will be one of the
       *following.
       */
       SF_LOOP_NONE = 800,
       SF_LOOP_FORWARD,
...
enum { SF_SEEK_SET = SEEK_SET, SF_SEEK_CUR = SEEK_CUR, SF_SEEK_END = SEEK_END };
...
sf_count_t sf_write_double(SNDFILE *sndfile, const double *ptr,
                           sf_count_t items);
...
**
** These functions fail safely. Specifically, they will not allow you to
*overwrite
