...
{
    for (int i = 1; i <= 10; i++) {
        GameObjects::Position pos(i * 150, m_minY + 50, m_minX, m_maxX, m_minY, m_maxY);
        std::shared_ptr<GameObjects::EnemyShip> enemyShip = std::make_shared<GameObjects::EnemyShip>(1, m_playersShipStartSpeed, 1, pos);
