...
void LevelManager::update()
{
    ...
    if(currentTime - m_lastSpawnTime >= m_spawnFrequency) {
        ...
        std::uniform_int_distribution<> distr(m_gameState.m_minX, m_gameState.m_maxX); // define the range
        ...
        enemyShip->setMovementStrategy(Game::Movement::VerticalMovementStrategy(100, 1));
