...
class GLWeaponBar {
public:
  GLWeaponBar(int slotCount = 4, float slotSize = 0.07f,
...
private:
  ...
  void drawTexturedQuad(QOpenGLFunctions_3_3_Core *gl, GLuint texture, float x,
                        float y, float w, float h, float screenW, float screenH,
                        float alpha);
  void drawCooldownPieOverlay(QOpenGLFunctions_3_3_Core *gl, float x, float y,
                              float w, float h, float cooldownFraction,
