...
public:
  AttractableGameObject(const Config::GameContext &ctx);
  ...
  void handleMagneticMovement(const QPointF &totalMagneticForce,
...
private:
  ...
  getMagneticObjectData(const UpdateContext &context);
};
