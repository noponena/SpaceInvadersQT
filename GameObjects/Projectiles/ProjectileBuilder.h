...
public:
    ...
    ProjectileBuilder &withMovementStrategy(const Game::Movement::MovementStrategy &strategy);
    ...
    ProjectileBuilder &withDestructionSound(const Game::Audio::SoundInfo destructionSound);
