...
Vortex::Vortex()
    : m_timeToLiveSeconds(5.0f),
    m_timeSinceSpawnSeconds(0.0f)
{
    m_magnetism = Magnetism{true, false, 200, 200};
    m_spawnSoundInfo = Game::Audio::SoundInfo({true, Game::Audio::SoundEffect::VORTEX_CANNON});
...
{
    std::unique_ptr<Vortex> projectile =
        std::make_unique<Vortex>();
