...
HealthBar::HealthBar(float health, float width, float height,
                     QGraphicsItem *parent)
    : QGraphicsItem(parent), m_currentHealth(health), m_maxHealth(health),
      m_healthPercentage(1.0f), m_width(width), m_height(height),
...
void HealthBar::clampCurrentHealth() {
